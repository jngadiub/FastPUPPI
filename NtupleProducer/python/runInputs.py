...
process.source = cms.Source("PoolSource",
                ...
                #'file:PhaseIISpring17D_SinglePion_PU0.root'
		#'file:PhaseIISpring17D_SinglePion0_PU0.root'
		'/store/mc/PhaseIISpring17D/SinglePion0_FlatPt-8to100/GEN-SIM-DIGI-RAW/PU140_90X_upgrade2023_realistic_v9-v1/70000/FCD4C606-B428-E711-97F9-A0000420FE80.root'
		),
...
process.s = cms.Sequence(
    ...
    process.ecalDigis + process.ecalPreshowerDigis + process.hcalDigis + process.bunchSpacingProducer + process.ecalLocalRecoSequence + process.hcalLocalRecoSequence + process.hcalGlobalRecoSequence +
    ...
    process.l1tPFEcalProducerFromOfflineRechits + process.l1tPFHcalProducerFromOfflineRechits + process.l1tPFHFProducerFromOfflineRechits +
    #process.l1tPFHGCalEEProducerFromOfflineRechits + process.l1tPFHGCalFHProducerFromOfflineRechits + process.l1tPFHGCalBHProducerFromOfflineRechits +
...
process.out = cms.OutputModule("PoolOutputModule",
	    ...
	    "keep *_L1Tk*_*_*",
            "keep *_l1tPF*_*_IN",
            "keep *_L1EGammaCrystalsProducer_L1EGXtals_IN",
        ),
